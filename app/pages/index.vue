...
<template>
  ...
  <section id="content" class="container min-h-screen bg-image bg-secondary-wallpaper">
    ...
    <p class="font-4xl w-3/4">
      We Now Offer Server Hosting Again! Inquire If Interested At <NuxtLink to="/contact">Our Contact Page</NuxtLink> Or Use the Chat Button To The Bottom Left!<br/>
      ...
      I also take 3D print commissions! <NuxtLink to="/contact">Just hit vanillyneko up!</NuxtLink> <br/>
      ...
      I also helped out over at <a target="_blank" href="https://foliumhosting.net/r/vanillyneko">Folium Hosting</a>! They Have Really Reliable Services!!! <br/>
  ...
  <section class="container min-h-screen bg-image bg-tertiary-wallpaper">
    ...
    <ul class="font-2xl w-3/4">
      ...
      <li>
        <p>
          <span class="font-bold">Storage</span>: 1tb Samsung 970 EVO nvme, 1 WD Red 2tb, 1 Seagate 3tb, 1 External Seagate 6tb, 1 External 6tb WD (inaccurate will update later)
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <span class="font-bold">Drawing Tablets</span>: Huion Q11K Wireless Tablet With Pen, Artisul D13, Wacom Bamboo
        </p>
      </li>
      <li>
        <p>
          <span class="font-bold">VR Headset</span>: Playstation VR 2 Headset with PC Adapter And Also iPhone Full Body + Additional Guestimate Help Program
        </p>
      </li>
      <li>
        <p>
      ...
      <li>
        <p>
          <span class="font-bold">Internet</span>: Suddenlink/Optimum 1 Gbps/52 Mbps, T-Mobile Home Internet 300mbps/70mbps
        </p>
      </li>
      <li>
        <p>
